...
public class SettingPage extends AdminHomePage {
	...
	private class SettingPageUIMap {
		public final IButton personalRegistr;
		public final IButton mixedRegister;
		public final IButton commissionerRegister;
		public final ITextField timeZone;
		public final IButton confirmChanges;

		public SettingPageUIMap() {
			this.personalRegistr = Button.get().getByXpath("//input[@value = 'PERSONAL']");
			this.mixedRegister =Button.get().getByXpath("//input[@value = 'MIXED']");
			this.commissionerRegister = Button.get().getByXpath("//input[@value ='MANUAL']");
