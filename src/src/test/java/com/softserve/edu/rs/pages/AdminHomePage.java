...
public class AdminHomePage {
	...
	private class StatusUsersPageUIMap {
		...
		public StatusUsersPageUIMap() {
			...
			this.nonConfirmed = Link.get()
					.getByXpath("//a[contains(@href,'/users/get-all-users?statusType=notcomfirmed')]");
	...
	public ShowAllCommunitiesPage gotoShowAllCommunitiesPage() {
		clickCommunities();
