...
public class EditCommunityPage {
	...
	private void setDataForEditCommunity(EditCommunity newEditData) {

		clickEditCommunityField();
		clearEditCommunityField();
		setEditCommunity(newEditData.getNameCommunityEdit());

		clickEditRegisterNumberField();
		clearEditRegisterNumberField();
		setEditRegisterNumber(newEditData.getRegisterNumberEdit());

	}

	public ShowAllCommunitiesPage successInputData(EditCommunity newEditData) {
		setDataForEditCommunity(newEditData);
