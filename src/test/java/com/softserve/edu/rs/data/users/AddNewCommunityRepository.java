...
public class AddNewCommunityRepository {
	 private static volatile AddNewCommunityRepository instance = null;
	    ...
	    public AddNewCommunity getCreateCommunityForCheckEditOption() {
	     	return AddNewCommunity.get().setnameCommunity("Полтавська територіальна громада")
	 					.setregisterNumber("111:34:22:222:22222")
	 					.build();			
	 	    }
	   ...
	   public AddNewCommunity getCommunityForDelete() {
			...
			return AddNewCommunity.get().setnameCommunity("Сумська територіальна громада")
	   ...
	   public AddNewCommunity getCommunityEmptyFields() {
	    ...
	    public AddNewCommunity getVerifyCorrectFormat() {
 			// TODO Read from file
 			return AddNewCommunity.get().setnameCommunity("Вінницька територіальна громада")
 					.setregisterNumber("122:22:05:22228295")
 					.build();			
 	    }
}
